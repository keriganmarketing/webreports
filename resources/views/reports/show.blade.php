        ...
        <div class="container">
            <div class="row align-items-center justify-content-between ">
                ...
                <div class="col-md-6 col-lg-4 p-3 pt-1">
                    <p class="text-center text-secondary display-3"><strong>{{ $company->name }}</strong><br><a target="_blank" href="{{ $company->url }}" class="display-4">{{ $company->url }}</a></p>
                </div>
                
                <div class="col-md-6 col-lg-4 col-xl-3 p-3 pt-1 flex-grow-1">
                    <p class="text-center text-lg-right text-primary display-3"><strong>{{ Carbon\Carbon::create($finalReport->year, $finalReport->month, 1)->format('F Y') }}</strong><br>Website Statistics Report</p>
                </div>
            ...
            <div class="row mt-2">
                <div class="col p-2 text-center bg-primary text-white">
                    ...
                    <p class="display-4"><strong>{{ Carbon\Carbon::create($finalReport->year, $finalReport->month, 1)->format('F Y') }}
                        vs
